...
app.post("/submit", (req, res) => {
  ...
  //3. Test to make sure that the random words display in the h1 element in index.ejs
    ...
    var numAdj = Math.floor(Math.random() * 1000) + 1;
    
    if(numAdj > adj.length){
      numAdj = adj.length-1;
    }
    else if (numAdj < 0){
      numAdj = 0;
    ...
    console.log(numAdj);
    var nameAdj = adj[numAdj];
    console.log(nameAdj)
    
    var numNoun = Math.floor(Math.random() * 1000) + 1;
    if(numNoun > adj.length){
      numNoun = adj.length-1;
    }
    else if (numNoun < 0){
      numNoun = 0;
    }
    ...
    console.log(numNoun);
    var nameNoun = noun[numNoun];
    console.log(nameNoun)
    var fullName = nameAdj + " " + nameNoun;
